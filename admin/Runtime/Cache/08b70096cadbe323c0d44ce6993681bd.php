...
<form method='post' id="form" name="form" action="<?php echo u('News/update');?>"  enctype="multipart/form-data">
<table cellpadding="0" cellspacing="0" width=100%>
	<tr>
		...
		<tr>
			...
			<td class="tLeft" >
				<div  style='margin-bottom:5px; '><input type='text' name='name_1' id='_1' class='bLeftRequire' value='中国电信金鹏天翼手机大卖场' /> </div>
			</td>
		</tr>
        <tr>
    ...
    <select name="cate_id" class="bLeftRequire">
				<option value="0" <?php if($vo['cate_id'] == 0): ?>selected="selected"<?php endif; ?>><?php echo (L("NO_CATE_SELECT")); ?></option>
				<?php if(is_array($cate_list)): foreach($cate_list as $key=>$cate_item): ?><option value="<?php echo ($cate_item["id"]); ?>" <?php if($vo['cate_id'] == $cate_item['id']): ?>selected="selected"<?php endif; ?>><?php echo ($cate_item[$select_dispname]); ?></option><?php endforeach; endif; ?>
				</select>
	</td>
</tr>
		<tr>
		...
		<tr>
			<td class="tRight" width="80"><?php echo (L("ARTICLE_REF_LINK")); ?>：</td>
			<td class="tLeft" >
				<input type='text' name='ref_link' id='' class='bLeft' value=''  />
			</td>
		</tr>
		...
		<tr>
			...
			<td class="tLeft" >
				<input type='text' name='sort' id='' class='bLeft' value='8'  />
			</td>
		</tr>
		...
		<tr>
			...
			<td class="tLeft" >
				<div style='margin-bottom:5px; '><textarea name='seokeyword_1' id='_1' class='bLeft' rows='2' cols='50' >asdfasdf</textarea> </div>
			</td>
		</tr>
		...
		<tr>
			...
			<td class="tLeft" >
				<div style='margin-bottom:5px; '><textarea name='seocontent_1' id='_1' class='bLeft' rows='2' cols='50' >asdf</textarea> </div>
			</td>
		</tr>
        <tr>
	<td class="tRight">相关图片：</td>
	<td class="tLeft" >
		<input type="file" name="image" class="bLeft"/>  <img src="__ROOT__/Public/upload/Article/<?php echo ($course["image"]); ?>" width="110" height="80"> <?php if($course['image'] != ''): ?><a href="__ROOT__/Public/upload/Article/<?php echo ($course["image"]); ?>" target="_blank"><?php echo L("VIEW");?></a><?php endif; ?>
	</td>
</tr>
		<tr>
			<td class="tRight" width="80">文章简介：</td>
			<td class="tLeft" >
				<textarea name='brief_1' id='' class='bLeft' rows='' cols='' style='width:650px;height:200px;' >fasdfasdf</textarea>
			</td>
		</tr>
		<tr>
			<td class="tRight" width="80"><?php echo (L("ARTICLE_CONTENT")); ?>：</td>
			<td class="tLeft" >
            <script type='text/javascript'>KE.show({id : 'content_1',cssPath : '__TMPL__ThemeFiles/Css/style.css',skinType: 'tinymce',allowFileManager : true});</script><div  style='margin-bottom:5px;widht:100% '><textarea id='content_1' name='content_1' style='width:700px;height:400px;visibility:hidden;' >fasdf<br />
</textarea> </div>
			</td>
		</tr>
		<!-- 价格体系 -->
