...
<form method='post' id="form" name="form" action="<?php echo u('ClassStyle/update');?>"  enctype="multipart/form-data">
<table cellpadding=0 cellspacing=0 class="dataEdit" >
    <tr>
        <td class="tRight" width="120"><?php echo (L("ARTICLE_CATE_NAME")); ?>：</td>
        <td class="tLeft" ><input type='text' name='name' id='' class='bLeftRequire' value='点对点的'  /></td>
    </tr>
    <!--tr>
