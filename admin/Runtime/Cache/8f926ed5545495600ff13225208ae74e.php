...
<form method='post' id="form" name="form" action="<?php echo u('Class/insert');?>"  enctype="multipart/form-data">
<table cellpadding="0" cellspacing="0" width=100% >
    ...
    <tr>
        ...
        <td class="tLeft" ><input type='text' name='name' id='' class='bLeftRequire' value=''  /></td>
    </tr> 
    <tr>        
        ...
        <td class="tLeft" >
            ...
            <?php if(is_array($trade_list)): foreach($trade_list as $key=>$trade_list): ?><option value="<?php echo ($trade_list["id"]); ?>"><?php echo ($trade_list["name"]); ?></option><?php endforeach; endif; ?>
            </select>
        </td>
    </tr>
    <tr>        
        ...
        <td class="tLeft" >
            ...
            <?php if(is_array($style_list)): foreach($style_list as $key=>$style_list): ?><option value="<?php echo ($style_list["id"]); ?>"><?php echo ($style_list["name"]); ?></option><?php endforeach; endif; ?>
            </select>
        </td>
    </tr>
    <tr>
        <td class="tRight" width="120">现价：</td>
        <td class="tLeft" ><input type='text' name='price' id='' class='bLeftRequire' value=''  /></td>
    </tr> 
    <tr>
        <td class="tRight" width="120">原价：</td>
        <td class="tLeft" ><input type='text' name='yprice' id='' class='bLeftRequire' value=''  /></td>
    </tr> 
    <tr>
        <td class="tRight" width="120">教学目的：</td>
        <td class="tLeft" ><textarea name='mudi' id='' class='bLeftRequire' rows='' cols='' style='width:350px;height:120px;' ></textarea></td>
    </tr> 
    <tr>
        <td class="tRight" width="120">教材：</td>
        <td class="tLeft" ><textarea name='book' id='' class='bLeftRequire' rows='' cols='' style='width:350px;height:120px;' ></textarea></td>
    </tr> 
    <tr>
        <td class="tRight" width="120">适用对象：</td>
        <td class="tLeft" ><textarea name='objects' id='' class='bLeftRequire' rows='' cols='' style='width:350px;height:120px;' ></textarea></td>
    </tr>     
    <tr>
        <td class="tRight" width="80">关键字：</td>
        <td class="tLeft" ><input type='text' name='desc' id='' class='bLeft' value=''  /></td>
    </tr>    
    <tr>
        <td class="tRight"><?php echo (L("ARTICLE_CONTENT")); ?>：</td>
        <td class="tLeft" ><script type='text/javascript'>KE.show({id : 'content',cssPath : '__TMPL__ThemeFiles/Css/style.css',skinType: 'tinymce',allowFileManager : true});</script><div  style='margin-bottom:5px;widht:100%;  '><textarea id='content' name='content' style='width:700px;height:350px;visibility:hidden;' ></textarea> </div></td>
    </tr>
	</table>
		<!-- 普通信息 -->
		</td>
