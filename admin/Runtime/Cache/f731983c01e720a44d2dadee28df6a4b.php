...
<form method='post' id="form" name="form" action="<?php echo u('ClassStyle/insert');?>"  enctype="multipart/form-data">
<table cellpadding=0 cellspacing=0 class="dataEdit" >
    ...
    <!--tr>
        <td class="tRight" width="80"><?php echo (L("PARENT_CATE")); ?>：</td>
        <td class="tLeft" >
            <select name="pid" class="bLeft" onchange="loadCateType(this);">
    ...
    <tr>
        ...
        <td class="tLeft" ><input type="text" name="sort" class="bLeft" value="<?php echo ($new_sort); ?>" /></td>
    </tr>     
    <tr>
