...
//        	$parseStr="<script type='text/javascript' charset='utf-8' src='__PUBLIC__/admin/Js/kindeditor/kindeditor.js'></script>";
//        	else
        	$parseStr = "";
...
//        	if(strtoupper($type)=='KINDEDITOR'||strtoupper($type)=='EMAILEDITOR')
//        	$parseStr="<script type='text/javascript'  src='__PUBLIC__/admin/Js/kindeditor/kindeditor.js'></script>";
//        	else
        	$parseStr = "";
...
//            	}
        ...
        foreach($fields as $field) {//显示指定的字段
            ...
            if ($order){
            	if($ext&&$ext!='')
	            	$parseStr .= '<a href="javascript:sortBy(\''.$property[0].'\',\'{$sort}\',\''.ACTION_NAME.'\',\''.$ext.'\')" title="按照'.$showname[2].'{$sortType} ">'.$showname[0].'<eq name="order" value="'.$property[0].'" ><img src="__PUBLIC__/admin/Images/{$sortImg}.gif" width="12" height="17" border="0" align="absmiddle"></eq></a></th>';
	            else
	            	$parseStr .= '<a href="javascript:sortBy(\''.$property[0].'\',\'{$sort}\',\''.ACTION_NAME.'\')" title="按照'.$showname[2].'{$sortType} ">'.$showname[0].'<eq name="order" value="'.$property[0].'" ><img src="__PUBLIC__/admin/Images/{$sortImg}.gif" width="12" height="17" border="0" align="absmiddle"></eq></a></th>';
            }else{
